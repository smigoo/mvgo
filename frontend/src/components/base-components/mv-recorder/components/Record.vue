 ...
 * @LastEditTime: 2025-07-16 15:50:02
 * @FilePath: \src\components\base-components\mv-recorder\components\Record.vue
-->
<template>
  <div class="mv-record-box" :class="[{ disabled }, theme]" :style="styles?.boxStyle">
    <div class="record-button" @click="handleRecord" :style="styles?.buttonStyle">
      <CircleProgress
        v-if="isRecording"
        ref="progress"
        class="record-progress"
        :color="currentThemeConfig?.progressProps.color"
        :size="buttonSize"
        :thickness="thickness"
        :duration="3"
        mode="loop"
      ...
      <img
        ...
        title="开启录音"
      />
      <div v-else class="suspended-box opacity" title="关闭录音">
...
const emit = defineEmits(['onStart', 'onRecord', 'onEnd'])
