<template>
  <div class="c-monitor-main-content">
    ...
    <div class="c-monitor-vertical-tabs">
      ...
      >
        <span class="c-monitor-tab-text" :style="{ backgroundImage: 'url(' + bg10 + ')', backgroundSize: '100% 100%', backgroundPosition: '0px 0px', backgroundRepeat: 'no-repeat' }">{{ tab.name }}</span>
      ...
      >
        ...
        <div class="c-monitor-device-content">
          ...
          <div class="c-monitor-device-value">
            ...
            <span class="c-monitor-device-total" :style="{ backgroundImage: 'url(' + bg9 + ')', backgroundSize: '100% 100%', backgroundPosition: '0px 0px', backgroundRepeat: 'no-repeat' }">/{{ device.total }}</span>
          </div>
        </div>
      </div>
    </div>
...
<script setup>
import bg10 from '../../resources/images/bg-8439.png'
