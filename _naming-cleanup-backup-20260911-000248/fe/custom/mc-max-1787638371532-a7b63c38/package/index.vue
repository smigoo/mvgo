<template>
  <base-panel panelKey="default-panel">
    <template #title_left>
      <img :src="icon1" class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-title-decor" />
    </template>

    <div class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-root">
      <!-- 监测类型与视图控制 -->
      <div class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-controls">
        <div class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-tabs">
          <div
            v-for="tab in tabs"
            :key="tab.key"
          ...
          >
            <div
              ...
              class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-tab-active-bg"
              :style="{ backgroundImage: `url(${bg3})` }"
            ></div>
            <span class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-tab-text">{{ tab.label }}</span>
          </div>
        </div>

        <div class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-view-icons">
          <img :src="icon2" class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-view-icons-img" />
          <div class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-badge">6</div>
        </div>
      </div>

      <!-- 浓度趋势图 -->
      <div class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-chart-wrapper">
        <div ref="chartRef" class="c-mc-max-1787638371532-a7b63c38-c-env-monitor-chart"></div>
      </div>
    </div>
  </base-panel>
</template>
