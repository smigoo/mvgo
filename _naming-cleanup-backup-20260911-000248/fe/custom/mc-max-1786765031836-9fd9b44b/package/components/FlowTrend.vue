      ...
      <div class="c-monitor-trend-chart-wrapper">
        <div class="c-monitor-trend-legend">
          ...
          >
            ...
            <i class="c-monitor-trend-legend-dot" style="background: #00d0ff;"></i>
            上海方向
          </span>
        </div>
...
// [Style Refine] 柱子渐变色还原
const getBarGradient = (colors) => new echarts.graphic.LinearGradient(0, 0, 0, 1, [
  ...
  series: [
    {
      ...
      type: 'bar',
      data: data.beijing,
      /* [Style Refine] 北京方向渐变 & 建议分流颜色修正 */
      itemStyle: { 
        color: getBarGradient(['#18ffff', '#00a2d7']), 
    ...
    },
    {
      ...
      /* [Style Refine] 上海方向渐变 */
      itemStyle: { 
        color: getBarGradient(['#1890ff', '#3c4fff']), 
        borderRadius: [2, 2, 0, 0] 
      },
      barWidth: 4
    }
