<template>
  <base-panel panelKey="default-panel">
    <div class="c-119ab2-content" :style="{ backgroundImage: `url(${bg1})` }">
      ...
      <!-- [Layout Refine] Figma num badge: 绝对定位到右上角 -->
...
const updateChart = () => {
  ...
  const option = {
    ...
    xAxis: {
      ...
      boundaryGap: false,
      /* [Style Refine] Figma X轴线 stroke: rgb(0.69, 0.788, 0.874) */
      axisLine: { lineStyle: { color: '#B0C9DF', width: 0.8 } },
      /* [Style Refine] Figma X轴标签 fill: rgb(0.2, 0.2, 0.2) = #333333 */
    ...
    yAxis: {
      ...
      axisLine: { show: false },
      axisTick: { show: false },
      /* [Style Refine] Figma Y轴标签 fill: rgb(0.2, 0.2, 0.2) = #333333 */
      axisLabel: { color: '#333333', fontSize: 12 },
      /* [Style Refine] Figma Line 1 stroke: rgb(0.741, 0.831, 0.91) = #BDD4E8 */
      splitLine: { lineStyle: { color: '#BDD4E8', type: 'solid', width: 0.8 } }
    },
    series: [
      {
        name: 'zk3+785CO浓度',
        ...
        smooth: true,
        symbol: 'none',
        /* [Style Refine] Figma Vector 1303 stroke: rgb(0.06, 0.804, 0.492) = #0FCD7D */
        lineStyle: { color: '#0FCD7D', width: 1 },
        /* [Style Refine] Figma Vector 1304 fills: gradient alpha 0.4 → 0 */
        areaStyle: {
          color: {
            type: 'linear',
            x: 0, y: 0, x2: 0, y2: 1,
        ...
        markLine: {
          silent: true,
          symbol: 'none',
          /* [Style Refine] Figma 预警线 stroke: rgb(0.827, 0.184, 0.184) = #D32F2F */
          ...
          data: [
            {
              ...
              label: {
                formatter: '预警线',
                /* [Style Refine] Figma 预警线 text fill: rgb(0.827, 0.184, 0.184) */
                color: '#D32F2F',
                fontSize: 12,
...
/* [Style Refine] Figma bg-size rule: 严禁 cover/contain → 100% 100% */
.c-119ab2-content {
  width: 100%;
  height: 100%;
...
/* [Layout Refine] Figma sub-t bbox: y=898, h=32 → padding 5px 0 0 0 */
...
/* [Style Refine] Figma tabs-list bg fills: linear-gradient + stroke #FFF 0.72px */
.c-119ab2-tabs-list {
  display: flex;
  flex-direction: row;
  align-items: center;
  gap: 4px;
  background: linear-gradient(to right, rgb(181, 222, 255), rgb(209, 236, 255));
...
/* [Layout Refine] Figma tabs-icon frame: x=1816, y=905, w=52, h=24 */
...
/* [Style Refine] Figma tabs-icon bbox: 52x24 */
.c-119ab2-view-icon {
  width: 52px;
  height: 24px;
  cursor: pointer;
...
/* [Layout Refine] Figma num badge: 绝对定位 x=1861, y=898 (右上角) */
/* [Style Refine] Figma num bg fill: rgb(0.961, 0.247, 0.247) = #F53F3F, cornerRadius: 29 */
.c-119ab2-badge {
  position: absolute;
  top: 0;
  right: 0;
...
/* [Layout Refine] Figma @echarts/line: y=930, h=113, 占 slot-con 剩余空间 */
