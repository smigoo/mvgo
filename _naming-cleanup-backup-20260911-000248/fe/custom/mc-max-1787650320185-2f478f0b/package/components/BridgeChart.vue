<template>
  <div class="c-mc-max-1787650320185-2f478f0b-c-monitor-section-bridge">
    <div class="c-mc-max-1787650320185-2f478f0b-c-monitor-section-header">
      <img :src="icon6" class="c-mc-max-1787650320185-2f478f0b-c-monitor-section-icon" alt="icon" />
      <span class="c-mc-max-1787650320185-2f478f0b-c-monitor-section-title">江阴大桥</span>
    </div>
    <div class="c-mc-max-1787650320185-2f478f0b-c-monitor-chart-body">
      <div class="c-mc-max-1787650320185-2f478f0b-c-monitor-chart-legend">
        <span
          class="c-mc-max-1787650320185-2f478f0b-c-monitor-legend-item"
          :class="{ 'is-active': legendState.beijing }"
          @click="toggleLegend('北京方向')"
        >
          <i class="c-mc-max-1787650320185-2f478f0b-c-monitor-legend-dot" style="background: #1890ff"></i>
          <span>北京方向</span>
        </span>
        <span
          class="c-mc-max-1787650320185-2f478f0b-c-monitor-legend-item"
        ...
        >
          <i class="c-mc-max-1787650320185-2f478f0b-c-monitor-legend-dot" style="background: #13c2c2"></i>
          <span>上海方向</span>
        </span>
      </div>
      <div ref="chartRef" class="c-mc-max-1787650320185-2f478f0b-c-monitor-chart-container"></div>
    </div>
  </div>
</template>
