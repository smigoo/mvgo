...
<span class="c-mc-max-1787923891329-6921ec8a-c-monitor-legend-item" :class="{ active: legendState['actual'] }" @click="toggleLegend('实际流量')" >
          <i class="c-mc-max-1787923891329-6921ec8a-c-monitor-legend-dot c-mc-max-1787923891329-6921ec8a-actual"></i>实际流量
        </span>
<span class="c-mc-max-1787923891329-6921ec8a-c-monitor-legend-item" :class="{ active: legendState['predicted'] }" @click="toggleLegend('预测流量')" >
...
// 图表数据
const dataMap = { tunnel: { 'actual': [2800, 2900, 3100, 3000, 2950], 'predicted': [2850, 2920, 3050, 2980, 2900]
  },
  bridge: {
