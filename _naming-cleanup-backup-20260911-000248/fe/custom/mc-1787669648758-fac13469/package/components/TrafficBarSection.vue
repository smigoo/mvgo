<template>
  <div class="c-mc-max-1787669212260-72ba6f17-c-monitor-bar-section">
    <div class="c-mc-max-1787669212260-72ba6f17-c-monitor-bar-header">
      <span class="c-mc-max-1787669212260-72ba6f17-c-monitor-bar-decor"></span>
      <span class="c-mc-max-1787669212260-72ba6f17-c-monitor-bar-title">{{ locationName }}</span>
    </div>
    <div class="c-mc-max-1787669212260-72ba6f17-c-monitor-bar-legend">
      <span 
        class="c-mc-max-1787669212260-72ba6f17-c-monitor-legend-item" 
        :class="{ active: legendState.beijing }" 
        @click="toggleLegend('北京方向')"
      >
        <i class="c-mc-max-1787669212260-72ba6f17-c-monitor-legend-dot" style="background: #1890ff;"></i>
        北京方向
      </span>
      <span 
        class="c-mc-max-1787669212260-72ba6f17-c-monitor-legend-item" 
      ...
      >
        <i class="c-mc-max-1787669212260-72ba6f17-c-monitor-legend-dot" style="background: #69c0ff;"></i>
        上海方向
      </span>
    </div>
    <div class="c-mc-max-1787669212260-72ba6f17-c-monitor-bar-chart-wrapper">
      <div ref="chartRef" class="c-mc-max-1787669212260-72ba6f17-c-monitor-bar-chart"></div>
    </div>
  </div>
</template>
