<template>
  <div class="c-monitor-vehicle-section">
    ...
    <div class="c-monitor-vehicle-header">
      <img :src="diamondIcon" class="c-monitor-vehicle-header-icon" alt="车型分布" />
      <span class="c-monitor-vehicle-header-title">车型分布</span>
    </div>
    ...
    <div class="c-monitor-vehicle-cards">
      ...
      <div class="c-monitor-vehicle-card">
        ...
        >
          ...
          <div class="c-monitor-vehicle-gauge" ref="tunnelGaugeRef"></div>

          <div class="c-monitor-vehicle-stat-group c-monitor-vehicle-stat-group--align-end">
            <span class="c-monitor-vehicle-stat-label c-monitor-vehicle-stat-label--right">货车</span>
      ...
      <div class="c-monitor-vehicle-card">
        ...
        >
          ...
          <div class="c-monitor-vehicle-gauge" ref="bridgeGaugeRef"></div>
