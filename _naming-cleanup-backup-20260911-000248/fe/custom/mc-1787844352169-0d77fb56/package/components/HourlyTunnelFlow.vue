<template>
  <div class="c-mc-1787844352169-0d77fb56-c-monitor-hourly-tunnel">
    <div class="c-mc-1787844352169-0d77fb56-c-monitor-section-header">
      <div class="c-mc-1787844352169-0d77fb56-c-monitor-title-bar">
        <span class="c-mc-1787844352169-0d77fb56-c-monitor-title-icon"></span>
        <span class="c-mc-1787844352169-0d77fb56-c-monitor-title-text">江阴靖江长江隧道</span>
      </div>
    </div>
    ...
    <div class="c-mc-1787844352169-0d77fb56-c-monitor-chart-wrapper">
      ...
      <div class="c-mc-1787844352169-0d77fb56-c-monitor-chart-legend">
        <span 
          ...
          :class="{ active: legendState['c-monitor-beijing'] }" 
          @click="toggleLegend('北京方向')"
        >
          <i class="c-mc-1787844352169-0d77fb56-c-monitor-legend-dot c-mc-1787844352169-0d77fb56-c-monitor-beijing"></i>北京方向
        </span>
        <span 
          class="c-mc-1787844352169-0d77fb56-c-monitor-legend-item" 
          :class="{ active: legendState['c-monitor-shanghai'] }" 
          @click="toggleLegend('上海方向')"
        >
          <i class="c-mc-1787844352169-0d77fb56-c-monitor-legend-dot c-mc-1787844352169-0d77fb56-c-monitor-shanghai"></i>上海方向
        </span>
      </div>
    </div>
  </div>
...
const mockData = {
  ...
  'c-monitor-beijing': [150, 180, 220, 280, 320, 380, 420, 450, 380, 320, 280, 240, 200],
  'c-monitor-shanghai': [140, 170, 210, 260, 300, 360, 400, 430, 370, 310, 270, 230, 190]
}

const toggleLegend = (name) => {
  if (!chart) return
  chart.dispatchAction({ type: 'legendToggleSelect', name })
  const key = name === '北京方向' ? 'c-monitor-beijing' : 'c-monitor-shanghai'
