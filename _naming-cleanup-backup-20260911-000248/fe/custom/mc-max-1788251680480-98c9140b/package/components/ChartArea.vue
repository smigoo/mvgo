...
<span class="c-env-monitor-legend-item" :class="{ active: legendState.main }" @click="toggleLegend('zk3+785CO浓度')" >
        <i class="c-env-monitor-legend-dot" style="background: #0fcd7d"></i>
        zk3+785CO浓度
      </span>
<span class="c-env-monitor-legend-item" :class="{ active: legendState.warning }" @click="toggleLegend('预警线')" >
...
// 图例状态
const legendState = ref({ main: true, warning: true
})
