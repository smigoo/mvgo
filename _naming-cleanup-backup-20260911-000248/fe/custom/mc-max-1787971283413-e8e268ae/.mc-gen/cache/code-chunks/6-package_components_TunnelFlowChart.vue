<template>
  <div class="c-monitor-tunnel-chart-wrapper">
    ...
    <div class="c-monitor-tunnel-header">
      <div class="c-monitor-tunnel-title">
        <i class="c-monitor-tunnel-title-icon"></i>
    ...
    <div class="c-monitor-tunnel-chart-body">
      ...
      <div class="c-monitor-tunnel-legend">
        <span 
          class="c-monitor-tunnel-legend-item" 
          :class="{ active: legendState.beijing }" 
          @click="toggleLegend('北京方向')"
        >
          <i class="c-monitor-tunnel-legend-dot beijing"></i>
          北京方向
        </span>
        <span 
          class="c-monitor-tunnel-legend-item" 
        ...
        >
          <i class="c-monitor-tunnel-legend-dot shanghai"></i>
          上海方向
        </span>
      </div>
