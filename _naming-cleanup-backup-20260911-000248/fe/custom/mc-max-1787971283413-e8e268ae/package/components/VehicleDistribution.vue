<template>
  <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-distribution">
    <!-- Section Header -->
    <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-section-header">
      <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-title-box">
        <span class="c-mc-max-1787971283413-e8e268ae-c-monitor-title-icon"></span>
        <span class="c-mc-max-1787971283413-e8e268ae-c-monitor-title-text">车型分布</span>
      </div>
    </div>

    <!-- Section Body -->
    <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-body">
      <!-- 江阴靖江长江隧道 -->
      <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-card">
        <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-chart-wrapper">
          <div ref="tunnelChartRef" class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-chart"></div>
        </div>
        <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stats">
          <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-item">
            <span class="c-monitor-vehicle-stat-dot c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-dot-passenger"></span>
            <span class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-label">客车</span>
            <span class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-value">22350</span>
          </div>
          <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-item">
            <span class="c-monitor-vehicle-stat-dot c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-dot-truck"></span>
            <span class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-label">货车</span>
            <span class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-value">16270</span>
          </div>
        </div>
      </div>
      ...
      <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-card">
        <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-chart-wrapper">
          <div ref="bridgeChartRef" class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-chart"></div>
        </div>
        <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stats">
          <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-item">
            <span class="c-monitor-vehicle-stat-dot c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-dot-passenger"></span>
            <span class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-label">客车</span>
            <span class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-value">66109</span>
          </div>
          <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-item">
            <span class="c-monitor-vehicle-stat-dot c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-dot-truck"></span>
            <span class="c-mc-max-1787971283413-e8e268ae-c-monitor-vehicle-stat-label">货车</span>
