      ...
      <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-tunnel-legend">
        <span 
         ...
         :style="legendState.beijing ? { backgroundImage: 'url(' + bg2 + ')', backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' } : null">
          <i class="c-mc-max-1787971283413-e8e268ae-c-monitor-tunnel-legend-dot c-mc-max-1787971283413-e8e268ae-beijing"></i>
          北京方向
        </span>
        <span 
          class="c-mc-max-1787971283413-e8e268ae-c-monitor-tunnel-legend-item" 
        ...
        >
          <i class="c-mc-max-1787971283413-e8e268ae-c-monitor-tunnel-legend-dot c-mc-max-1787971283413-e8e268ae-shanghai"></i>
          上海方向
        </span>
      </div>
...
const chartData = ref({
  ...
  'beijing': [200, 180, 150, 120, 300, 350, 400, 600, 825, 650, 500, 300, 250],
  'shanghai': [150, 160, 140, 130, 280, 320, 380, 580, 831, 620, 480, 280, 230]
})
