<template>
  <div class="c-env-monitor-chart-section">
    ...
    <div class="c-env-monitor-stats-panel">
      <div class="c-env-monitor-stat-item">
        <img :src="icon1" class="c-env-monitor-stat-icon" />
        <span class="c-env-monitor-stat-label">2k3+785CO浓度</span>
      </div>
      <div class="c-env-monitor-stat-item">
        <img :src="icon2" class="c-env-monitor-stat-icon" />
        <span class="c-env-monitor-stat-label c-env-monitor-stat-label-warning">预警线</span>
      </div>
    </div>
  </div>
</template>
