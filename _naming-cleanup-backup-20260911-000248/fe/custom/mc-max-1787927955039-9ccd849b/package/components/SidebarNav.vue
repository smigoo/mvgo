<template>
  <div class="c-mc-max-1787927955039-9ccd849b-c-monitor-sidebar">
    <div 
    ...
    >
      <span class="c-mc-max-1787927955039-9ccd849b-c-monitor-sidebar-label">{{ item.label }}</span>
      <span v-if="item.badge" class="c-mc-max-1787927955039-9ccd849b-c-monitor-sidebar-badge">{{ item.badge }}</span>
    </div>
  </div>
</template>
