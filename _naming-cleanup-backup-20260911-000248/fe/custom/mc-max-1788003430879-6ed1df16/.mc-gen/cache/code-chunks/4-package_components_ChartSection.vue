<template>
  <div class="c-env-monitor-chart-section">
    ...
    <div class="c-env-monitor-chart-header">
      <span class="c-env-monitor-chart-label">当</span>
      <span class="c-env-monitor-chart-value">40</span>
      <span class="c-env-monitor-chart-location">zk3+785CO浓度</span>
    </div>

    <!-- 阈值线 -->
    <div class="c-env-monitor-threshold-line">
      <span class="c-env-monitor-threshold-value">30</span>
      <div class="c-env-monitor-threshold-dash"></div>
      <span class="c-env-monitor-threshold-label">阈值线</span>
    </div>
    ...
    <!-- X轴时间刻度 -->
    <div class="c-env-monitor-x-axis">
      <span v-for="hour in xAxisData" :key="hour" class="c-env-monitor-x-axis-item">{{ hour }}</span>
      <span class="c-env-monitor-x-axis-unit">时</span>
    </div>
  </div>
</template>
