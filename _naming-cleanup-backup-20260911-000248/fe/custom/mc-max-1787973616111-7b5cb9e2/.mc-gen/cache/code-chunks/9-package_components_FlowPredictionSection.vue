<template>
  <div class="c-monitor-flow-prediction-section">
    <!-- 区域标题和Tab切换 -->
    <div class="c-monitor-section-header">
      <div class="c-monitor-section-title-group">
        <img v-if="icon3" :src="icon3" class="c-monitor-title-icon" alt="" />
    ...
    <div class="c-monitor-chart-body">
      ...
      <div class="c-monitor-chart-legend">
        ...
        >
          <span class="c-monitor-legend-line" :style="{ background: legend.color }"></span>
          <span class="c-monitor-legend-text">{{ legend.name }}</span>
        </div>
      </div>
      ...
      <div class="c-monitor-accuracy-labels">
        <span
          ...
          :key="index"
          class="c-monitor-accuracy-label"
          :class="{ empty: !label }"
        >
          {{ label }}
        </span>
