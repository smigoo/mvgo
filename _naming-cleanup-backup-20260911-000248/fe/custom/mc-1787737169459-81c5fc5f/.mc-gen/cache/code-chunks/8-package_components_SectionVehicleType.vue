<template>
  <section class="c-monitor-vehicle-section">
    <div class="c-monitor-vehicle-header">
      <img :src="icon6" class="c-monitor-vehicle-header-icon" alt="车型分布" />
    ...
    <div class="c-monitor-vehicle-cards">
      ...
      <div class="c-monitor-vehicle-card">
        <div
          class="c-monitor-vehicle-card-top"
          :style="{ backgroundImage: `url(${bg2})` }"
        >
          <span class="c-monitor-vehicle-card-name">江阴靖江长江隧道</span>
          <div ref="tunnelChartRef" class="c-monitor-vehicle-chart"></div>
        </div>
        <div class="c-monitor-vehicle-stats">
          <div
            class="c-monitor-vehicle-stat"
          ...
          >
            ...
            <span class="c-monitor-vehicle-stat-value c-monitor-vehicle-stat-value--freight">16270</span>
          </div>
        </div>
      </div>
      ...
      <div class="c-monitor-vehicle-card">
        ...
        >
          <span class="c-monitor-vehicle-card-name">江阴大桥</span>
...
const legendStates = reactive({
  tunnel: { passenger: true, freight: true },
  bridge: { passenger: true, freight: true }
})
