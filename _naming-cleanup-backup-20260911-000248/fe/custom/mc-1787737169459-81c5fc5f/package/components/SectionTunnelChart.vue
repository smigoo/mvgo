<template>
  <div class="c-mc-max-1787736422136-74deb182-c-monitor-section-tunnel">
    <div class="c-mc-max-1787736422136-74deb182-c-monitor-section-header">
      <span class="c-mc-max-1787736422136-74deb182-c-monitor-section-title">江阴靖江长江隧道</span>
    </div>
    <div class="c-mc-max-1787736422136-74deb182-c-monitor-chart-wrapper">
      <div ref="chartRef" class="c-mc-max-1787736422136-74deb182-c-monitor-chart-container"></div>
    </div>
  </div>
</template>
...
const option = { tooltip: { trigger: 'axis', backgroundColor: 'rgba(255, 255, 255, 0.95)', borderColor: '#e8e8e8', borderWidth: 1, textStyle: { color: '#333333', fontSize: 12 }, axisPointer: { type: 'shadow', shadowStyle: { color: 'rgba(0, 0, 0, 0.05)' } }
    },
    legend: {
      data: ['北京方向', '上海方向'],
      top: 0,
