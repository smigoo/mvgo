<template>
  <div
    class="c-mc-max-1787986836595-feefacc9-c-monitor-device-grid"
    :style="{
  ...
  >
    <div class="c-mc-max-1787986836595-feefacc9-c-monitor-nav-tabs">
      <div
        v-for="tab in tabs"
        :key="tab.text"
      ...
      >
        <span class="c-mc-max-1787986836595-feefacc9-c-monitor-nav-tab-text">{{ tab.text }}</span>
        <span v-if="tab.text === activeTab && tab.badge" class="c-mc-max-1787986836595-feefacc9-c-monitor-nav-tab-count">{{ tab.badge }}</span>
        <span v-else-if="tab.badge" class="c-mc-max-1787986836595-feefacc9-c-monitor-nav-tab-dot">{{ tab.badge }}</span>
      </div>
    </div>

    <div class="c-mc-max-1787986836595-feefacc9-c-monitor-device-cards">
      <div v-for="device in devices" :key="device.id" class="c-mc-max-1787986836595-feefacc9-c-monitor-device-card">
        <div class="c-mc-max-1787986836595-feefacc9-c-monitor-device-card-icon"></div>
        <span class="c-mc-max-1787986836595-feefacc9-c-monitor-device-card-label">{{ device.label }}</span>
        <span
          :class="[
