<template>
  <div class="c-mc-max-env-monitor-verify-r6-c-env-monitor-tab-switch">
    <div class="c-mc-max-env-monitor-verify-r6-c-env-monitor-tabs-list" :style="{ backgroundImage: `url(${bg2})`, backgroundSize: '100% 100%', backgroundPosition: '0px 0px', backgroundRepeat: 'no-repeat' }">
      <div
        v-for="tab in tabs"
        :key="tab.value"
        class="c-mc-max-env-monitor-verify-r6-c-env-monitor-tab-item"
