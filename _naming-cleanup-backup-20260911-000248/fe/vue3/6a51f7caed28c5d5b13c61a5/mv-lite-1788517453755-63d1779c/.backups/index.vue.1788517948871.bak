<template>
  <div class="environment-monitor-20250120">
    <div class="environment-monitor-20250120-header">
      <div class="environment-monitor-20250120-title">环境监测</div>
      <div class="environment-monitor-20250120-tabs">
        <div
          v-for="tab in tabs"
          :key="tab"
      ...
      <div class="environment-monitor-20250120-actions">
    ...
    <div class="environment-monitor-20250120-chart">
...
.environment-monitor-20250120-header {
  display: flex;
  align-items: center;
  gap: 8px;
  margin-bottom: 6px;
...
.environment-monitor-20250120-title {
  font-size: 12px;
  font-weight: 500;
  color: #5CADEC;
  white-space: nowrap;
...
.environment-monitor-20250120-tabs {
  display: flex;
  gap: 6px;
  flex: 1;
}
...
.environment-monitor-20250120-actions {
  display: flex;
  gap: 6px;
  align-items: center;
}
...
.environment-monitor-20250120-chart {
  flex: 1;
  min-height: 0;
  position: relative;
}
