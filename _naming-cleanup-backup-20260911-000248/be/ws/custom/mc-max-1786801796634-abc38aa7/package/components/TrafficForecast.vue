...
const legendItems = [
  /* [Style Refine] fills[0].color → rgb(69, 121, 255) */
  { name: '实际流量', key: 'actual', color: '#4579FF' },
  /* [Style Refine] fills[0].color → rgb(0, 204, 204) */
    ...
    series: [
      {
        ...
        symbolSize: 6,
        showSymbol: true,
        /* [Style Refine] fills[0].color → rgb(51, 133, 255) */
        itemStyle: { color: '#3485FF', borderColor: '#fff', borderWidth: 1 },
        lineStyle: { color: '#3485FF', width: 2 },
        areaStyle: {
          color: {
...
.c-monitor-forecast-tab {
  ...
  font-size: 14px;
  font-weight: 400;
  /* [Style Refine] fills[0].color → rgb(51, 51, 51) */
  color: #333333;
  background: #6680A0;
...
/* [Style Refine] fills[0].color → rgb(23, 192, 46) */
