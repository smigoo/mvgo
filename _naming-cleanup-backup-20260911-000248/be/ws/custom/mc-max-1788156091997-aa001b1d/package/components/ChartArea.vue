<template>
  <div class="c-mc-max-1788156091997-aa001b1d-c-env-monitor-chart-area">
    <!-- 图表容器 -->
    <div ref="chartRef" class="c-mc-max-1788156091997-aa001b1d-c-env-monitor-chart-container"></div>
  </div>
</template>
