...
// 模拟不同 tab 的数据
const dataMap = {
  co: [5, 8, 12, 10, 15, 13, 11, 9, 14, 12, 10, 8],
  visibility: [20, 25, 30, 28, 35, 32, 30, 28, 33, 31, 29, 27],
  lighting: [40, 45, 50, 48, 55, 52, 50, 48, 53, 51, 49, 47],
  outdoor: [60, 65, 70, 68, 75, 72, 70, 68, 73, 71, 69, 67]
}
