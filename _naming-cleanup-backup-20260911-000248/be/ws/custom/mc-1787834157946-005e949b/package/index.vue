<template>
  <base-panel panelKey="default-panel">
    <template #header_right>
      <!-- Tab切换栏 -->
      <div class="c-mc-1787834157946-005e949b-c-env-monitor-tabs" :style="{ backgroundImage: 'url(' + bg3 + ')', backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' }">
        <div
          v-for="tab in tabs"
          :key="tab.value"
          :class="['c-env-monitor-tab-item', { c-mc-1787834157946-005e949b-active: activeTab === tab.value }]"
      ...
      <!-- 视图切换按钮 + 徽章 -->
      <div class="c-mc-1787834157946-005e949b-c-env-monitor-controls">
        <div
          :class="['c-env-monitor-icon-btn', { c-mc-1787834157946-005e949b-active: viewMode === 'chart' }]"
          @click="viewMode = 'chart'"
        >
          <img v-if="icon1" :src="icon1" class="c-mc-1787834157946-005e949b-c-env-monitor-icon" alt="图表视图" />
        </div>
        <div
          :class="['c-env-monitor-icon-btn', { c-mc-1787834157946-005e949b-active: viewMode === 'table' }]"
          @click="viewMode = 'table'"
        >
          <img v-if="icon2" :src="icon2" class="c-mc-1787834157946-005e949b-c-env-monitor-icon" alt="表格视图" />
        </div>
        <div class="c-mc-1787834157946-005e949b-c-env-monitor-badge">8</div>
      </div>
    </template>

    <!-- 主内容区 -->
    <div class="c-mc-1787834157946-005e949b-c-env-monitor-root">
      <!-- 图表区域 -->
      <div class="c-mc-1787834157946-005e949b-c-env-monitor-chart-section" :style="{ backgroundImage: `url(${bg2})`, backgroundSize: '100% 100%', backgroundPosition: 'center center', backgroundRepeat: 'no-repeat' }">
        <!-- 图表头部信息 -->
        <div class="c-mc-1787834157946-005e949b-c-env-monitor-chart-header">
          <span class="c-mc-1787834157946-005e949b-c-env-monitor-label-current">当前</span>
          <span class="c-mc-1787834157946-005e949b-c-env-monitor-label-value">zk3+785CO浓度</span>
          <span class="c-mc-1787834157946-005e949b-c-env-monitor-label-warning">预警线</span>
        </div>

        <!-- 图表容器 -->
        <div ref="chartRef" class="c-mc-1787834157946-005e949b-c-env-monitor-chart-container"></div>
      </div>
    </div>
  </base-panel>
</template>
