<template>
  <div class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-section">
    <!-- 分区标题（sub-header，非面板标题） -->
    <div class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-header">
      <img :src="icon2" class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-icon" alt="车型分布" />
      <span class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-title">车型分布</span>
    </div>

    <!-- 双饼图并排（horizontal-2-columns） -->
    <div class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-body">
      <!-- 江阴靖江长江隧道车型 -->
      <div
        class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-card"
        :style="{ backgroundImage: 'url(' + bg2 + ')', backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' }"
      >
        <div ref="tunnelChartRef" class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-chart"></div>
        <div class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend">
          <div class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-item">
            <span class="c-monitor-vehicle-dot c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-dot-bus"></span>
            <span class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-label">客车</span>
            <span class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-value">{{ tunnelData.bus }}</span>
          </div>
          <div class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-item">
            <span class="c-monitor-vehicle-dot c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-dot-truck"></span>
            <span class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-label">货车</span>
            <span class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-value">{{ tunnelData.truck }}</span>
          </div>
        </div>
      </div>
      ...
      >
        <div ref="bridgeChartRef" class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-chart"></div>
        <div class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend">
          <div class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-item">
            <span class="c-monitor-vehicle-dot c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-dot-bus"></span>
            <span class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-label">客车</span>
            <span class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-value">{{ bridgeData.bus }}</span>
          </div>
          <div class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-item">
            <span class="c-monitor-vehicle-dot c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-dot-truck"></span>
            <span class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-label">货车</span>
            <span class="c-mc-max-1788003319188-c32142f3-c-monitor-vehicle-legend-value">{{ bridgeData.truck }}</span>
          </div>
        </div>
      </div>
    </div>
