<template>
  <div class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction">
    <!-- 头部：标题 + tab 切换 + 节假日预测链接 -->
    <div class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-header">
      <div class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-title">
        <img :src="icon3" class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-title-icon" alt="icon" />
        <span class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-title-text">流量预测</span>
      </div>

      <div class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-tabs">
        <div
          v-for="tab in locationTabs"
          :key="tab.value"
          class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-tab"
      ...
      <span class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-link" @click="handleHolidayClick">节假日预测&gt;</span>
    </div>

    <!-- 图表区 -->
    <div class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-chart-wrapper">
      <div ref="chartRef" class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-chart"></div>
    </div>

    <!-- 底部准确率标注 -->
    <div class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-accuracy">
      <span
        v-for="(item, idx) in accuracyList"
        :key="idx"
        class="c-mc-max-1788003319188-c32142f3-c-monitor-prediction-accuracy-item"
      >
        准确率{{ item }}
      </span>
    </div>
