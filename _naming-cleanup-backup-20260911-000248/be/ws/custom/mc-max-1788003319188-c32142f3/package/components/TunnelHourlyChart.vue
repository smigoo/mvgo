<template>
  <div class="c-mc-max-1788003319188-c32142f3-c-monitor-tunnel-hourly">
    <!-- 标题行 -->
    <div class="c-mc-max-1788003319188-c32142f3-c-monitor-section-header">
      <div class="c-mc-max-1788003319188-c32142f3-c-monitor-section-title">
        <i class="c-mc-max-1788003319188-c32142f3-c-monitor-title-icon" :style="{ backgroundImage: `url(${icon3})` }"></i>
        <span class="c-mc-max-1788003319188-c32142f3-c-monitor-title-text">江阴靖江长江隧道</span>
      </div>
    </div>

    <!-- 图例区 -->
    <div class="c-mc-max-1788003319188-c32142f3-c-monitor-chart-legend">
      <span 
        class="c-mc-max-1788003319188-c32142f3-c-monitor-legend-item" 
       ...
       :style="legendState.beijing ? { backgroundImage: 'url(' + bg3 + ')', backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' } : null">
        <i class="c-monitor-legend-dot c-mc-max-1788003319188-c32142f3-c-monitor-legend-dot-blue"></i>
        <span class="c-mc-max-1788003319188-c32142f3-c-monitor-legend-label">北京方向</span>
      </span>
      <span 
        class="c-mc-max-1788003319188-c32142f3-c-monitor-legend-item" 
      ...
      >
        <i class="c-monitor-legend-dot c-mc-max-1788003319188-c32142f3-c-monitor-legend-dot-green"></i>
        <span class="c-mc-max-1788003319188-c32142f3-c-monitor-legend-label">上海方向</span>
      </span>
    </div>

    <!-- 图表容器 -->
    <div class="c-mc-max-1788003319188-c32142f3-c-monitor-chart-body">
      <div ref="chartRef" class="c-mc-max-1788003319188-c32142f3-c-monitor-chart-container"></div>
    </div>
  </div>
</template>
