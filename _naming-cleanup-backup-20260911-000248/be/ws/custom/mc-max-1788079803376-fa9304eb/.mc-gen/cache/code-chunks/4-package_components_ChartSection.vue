<template>
  <div class="c-env-monitor-chart-section">
    ...
    <div class="c-env-monitor-chart-header">
      <span class="c-env-monitor-chart-label">时间</span>
      <span class="c-env-monitor-chart-value">zk3+785CO浓度</span>
      <span class="c-env-monitor-chart-badge">预警线</span>
    </div>
...
const chartData = ref({
  ...
  yAxis: [0, 10, 20, 30, 40],
  series: [
    15, 18, 22, 25, 28, 32, 30, 28, 26, 24, 20, 18,
    16, 14, 12, 15, 18, 20, 22, 25, 28, 30, 28, 26
  ]
})
