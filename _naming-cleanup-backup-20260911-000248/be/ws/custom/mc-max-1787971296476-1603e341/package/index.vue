<template>
  <base-panel panelKey="default-panel">
    <div class="c-mc-max-1787971296476-1603e341-c-env-monitor-root">
      <!-- Tab切换栏 -->
      <div class="c-mc-max-1787971296476-1603e341-c-env-monitor-tabs" :style="{ backgroundImage: `url(${bg2})` }">
        <div
          v-for="tab in tabs"
          :key="tab.value"
        ...
        <!-- 右侧图标组 -->
        <div class="c-mc-max-1787971296476-1603e341-c-env-monitor-tab-icons">
          <img :src="icon1" class="c-mc-max-1787971296476-1603e341-c-env-monitor-icon" />
          <img :src="icon2" class="c-mc-max-1787971296476-1603e341-c-env-monitor-icon" />
          <div class="c-mc-max-1787971296476-1603e341-c-env-monitor-badge">6</div>
        </div>
      </div>

      <!-- 图表区域 -->
      <div class="c-mc-max-1787971296476-1603e341-c-env-monitor-chart-wrapper">
        <div ref="chartRef" class="c-mc-max-1787971296476-1603e341-c-env-monitor-chart-container"></div>
      </div>
    </div>
  </base-panel>
</template>
