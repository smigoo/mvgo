...
const bg1 = typeof window !== 'undefined' ? window.__MC_RESOURCE_bg1__ : ''
const bg2 = typeof window !== 'undefined' ? window.__MC_RESOURCE_bg2__ : ''
const icon1 = typeof window !== 'undefined' ? window.__MC_RESOURCE_icon1__ : ''
const icon2 = typeof window !== 'undefined' ? window.__MC_RESOURCE_icon2__ : ''
