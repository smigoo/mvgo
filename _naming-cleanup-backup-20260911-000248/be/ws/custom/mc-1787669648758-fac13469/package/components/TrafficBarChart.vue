<template>
  <div class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar">
    <!-- 标题行：图标 + 标题 + 图例 -->
    <div class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-header">
      <div class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-title-area">
        <span class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-title-icon"></span>
        <span class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-title-text">{{ sectionName }}</span>
      </div>
      <div class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-legend">
        <span
          class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-legend-item"
          :class="{ inactive: !legendState.beijing }"
          @click="toggleLegend('北京方向')"
        >
          <i class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-legend-dot beijing"></i>
          <span>北京方向</span>
        </span>
        <span
          class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-legend-item"
        ...
        >
          <i class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-legend-dot shanghai"></i>
          <span>上海方向</span>
        </span>
      </div>
    </div>
    ...
    <!-- 图表容器 -->
    <div class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-chart-wrapper">
      <div ref="chartRef" class="c-mc-max-1787669212260-72ba6f17-c-monitor-traffic-bar-chart"></div>
    </div>
  </div>
</template>
