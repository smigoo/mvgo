<template>
  <div class="c-monitor-bridge-chart-section">
    <div class="c-monitor-bridge-chart-header">
      <span class="c-monitor-bridge-chart-title">江阴大桥</span>
    </div>
    <div class="c-monitor-bridge-chart-body">
      <div ref="chartRef" class="c-monitor-bridge-chart-container" />
    </div>
  </div>
</template>
