    ...
    <div class="c-monitor-vehicle-content">
      ...
      <div class="c-monitor-vehicle-card">
        ...
        <div class="c-monitor-vehicle-card-content">
          <!-- 地点标签 -->
          <div class="c-monitor-vehicle-location">
            <span class="c-monitor-vehicle-location-bar"></span>
            <span class="c-monitor-vehicle-location-text">{{ tunnelVehicleData.label }}</span>
          </div>
          ...
          <div class="c-monitor-vehicle-stats">
            ...
            >
              <span class="c-monitor-vehicle-stat-label">{{ item.name }}</span>
              <span class="c-monitor-vehicle-stat-value" :style="{ color: item.color }">
      ...
      <div class="c-monitor-vehicle-card">
        ...
        <div class="c-monitor-vehicle-card-content">
          ...
          <div class="c-monitor-vehicle-location">
            <span class="c-monitor-vehicle-location-bar"></span>
            <span class="c-monitor-vehicle-location-text">{{ bridgeVehicleData.label }}</span>
          </div>
