<template>
  <base-panel panelKey="default-panel">
    <div class="c-mc-max-1788065970150-62e42150-c-env-monitor-root">
      <!-- Tab 切换栏 -->
      <div class="c-mc-max-1788065970150-62e42150-c-env-monitor-tabs-section" :style="{ backgroundImage: `url(${bg2})`, backgroundSize: '295px 27px', backgroundPosition: '0px 0px', backgroundRepeat: 'no-repeat' }">
        <div class="c-mc-max-1788065970150-62e42150-c-env-monitor-tabs-bg" :style="{ backgroundImage: `url(${bg2})`, backgroundSize: '100% 100%', backgroundPosition: 'center center', backgroundRepeat: 'no-repeat' }">
          <div 
            v-for="tab in tabs" 
            :key="tab.value"
          ...
          >
            <div 
              ...
              class="c-mc-max-1788065970150-62e42150-c-env-monitor-tab-active-bg"
              :style="{ backgroundImage: `url(${bg3})`, backgroundSize: '100% 100%', backgroundPosition: 'center center', backgroundRepeat: 'no-repeat' }"
            ></div>
            <span class="c-mc-max-1788065970150-62e42150-c-env-monitor-tab-text">{{ tab.label }}</span>
          </div>
        </div>
        <div class="c-mc-max-1788065970150-62e42150-c-env-monitor-tabs-icon-group">
          ...
          <img :src="icon2" class="c-mc-max-1788065970150-62e42150-c-env-monitor-icon-btn" />
        </div>
      </div>

      <!-- 图表区域 -->
      <div class="c-mc-max-1788065970150-62e42150-c-env-monitor-chart-section">
        <div class="c-mc-max-1788065970150-62e42150-c-env-monitor-chart-header">
          <span class="c-mc-max-1788065970150-62e42150-c-env-monitor-chart-label">zk3+785CO浓度</span>
          <div class="c-mc-max-1788065970150-62e42150-c-env-monitor-legend">
            <span class="c-mc-max-1788065970150-62e42150-c-env-monitor-legend-item">
              <i class="c-mc-max-1788065970150-62e42150-c-env-monitor-legend-dot"></i>
              预警线
            </span>
          </div>
        </div>
        <div ref="chartRef" class="c-mc-max-1788065970150-62e42150-c-env-monitor-chart-container"></div>
      </div>
    </div>
  </base-panel>
</template>
