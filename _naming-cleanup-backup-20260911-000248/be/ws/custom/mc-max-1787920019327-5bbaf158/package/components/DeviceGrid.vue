<template>
  <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-grid">
    <div
      v-for="device in deviceList"
      :key="device.id"
      class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-card"
    >
      <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-icon-wrapper">
        <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-icon-bg">
          <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-icon-circle-outer"></div>
          <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-icon-circle-inner"></div>
          <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-icon-dot-1"></div>
          <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-icon-dot-2"></div>
          <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-icon-dot-3"></div>
        </div>
        <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-icon-content">
          <component :is="device.iconComponent" />
        </div>
      </div>
      <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-info">
        <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-name">{{ device.name }}</div>
        <div class="c-mc-max-1787920019327-5bbaf158-c-monitor-device-count">{{ device.count }}</div>
      </div>
    </div>
  </div>
</template>
