  ...
  <base-panel panelKey="default-panel">
    ...
    <template #header-right>
      <div class="c-env-monitor-header-icons">
        ...
        <buttonclass="c-env-monitor-icon-btn" aria-label="视图切换与列表" type="button">
    ...
    <!-- [Style Refine] background-size: 100% 100% → 100% 100% (Figma bg-size 红线) -->
    <div 
    ...
    >
        ...
        <div class="c-env-monitor-tabs-list">
          ...
          >
            ...
            <div 
              ...
              :style="{ backgroundImage: `url(${bgtabActive})`, backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' }"
            ></div>
      ...
      <div class="c-env-monitor-chart-section">
        ...
        <!-- [Layout Refine] 移除固定高度，使用 flex:1 填充剩余空间 -->
...
const updateChart = () => {
  ...
  const option = {
    ...
    xAxis: {
      ...
      boundaryGap: false,
      /* [Style Refine] Figma Frame 2136636710 text color → rgb(51,51,51) */
      axisLine: { lineStyle: { color: 'rgb(177,212,231)' } },
      axisTick: { show: false },
      axisLabel: { color: 'rgb(51,51,51)', fontSize: 12, margin: 8 },
      name: '时',
      nameLocation: 'end',
      nameTextStyle: { color: 'rgb(102,102,102)', fontSize: 12, padding: [0, 0, 0, -10] }
    },
    yAxis: {
      type: 'value',
      min: 0,
      ...
      axisLine: { show: false },
      axisTick: { show: false },
      /* [Style Refine] Figma Line 1 stroke → rgb(189,212,232) */
      splitLine: { lineStyle: { color: 'rgb(189,212,232)', type: 'solid', width: 0.8 } },
      /* [Style Refine] Figma "40 30 20 10 0" text color → rgb(51,51,51) */
      axisLabel: { color: 'rgb(51,51,51)', fontSize: 12 },
      name: '辆',
      nameLocation: 'end',
      nameTextStyle: { color: 'rgb(102,102,102)', fontSize: 12, align: 'left' }
    },
    /* [Style Refine] 颜色值从 Figma fills 精确提取 */
    series: [
      {
        name: 'zk3+785CO浓度',
        type: 'line',
        smooth: true,
        symbol: 'none',
        /* [Style Refine] fills[0].color → rgb(15,205,125) = #0fcd7d */
        lineStyle: { width: 1, color: 'rgb(15,205,125)' },
        areaStyle: {
          /* [Style Refine] Figma Vector 1304 gradient stops */
        ...
        markLine: {
          silent: true,
          symbol: 'none',
          /* [Style Refine] Figma "预警线" text color → rgb(211,47,47) */
          lineStyle: { color: 'rgb(211,47,47)', type: 'dashed', width: 0.8 },
          label: {
            formatter: '预警线',
            color: 'rgb(211,47,47)',
            fontSize: 12,
...
/* [Layout Refine] 移除固定高度，使用 flex:1 按比例分配剩余空间 */
