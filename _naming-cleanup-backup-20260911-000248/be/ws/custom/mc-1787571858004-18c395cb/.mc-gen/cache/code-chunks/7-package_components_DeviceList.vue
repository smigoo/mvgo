  ...
  <div class="c-monitor-device-list">
    ...
    <div class="c-monitor-sidebar">
      <div
        v-for="tab in tabs"
        :key="tab.key"
        :class="['c-monitor-tab-item', { 'is-active': activeTab === tab.key }]"
...
// Tab 选项数据
const tabs = ref([
  { key: 'monitor', label: '监控', badge: null },
...
const deviceDataMap = {
  monitor: [
    { name: '摄像机', icon: icon6, abnormal: 2, total: 484 },
    { name: '风速风向仪', icon: icon7, abnormal: 1, total: 484 },
    { name: '超高检测器', icon: icon8, abnormal: 0, total: 484 },
    { name: '烟道机器人', icon: icon9, abnormal: 0, total: 484 },
    { name: '激光雷达', icon: icon10, abnormal: 0, total: 484 },
    { name: 'CO传感器', icon: icon11, abnormal: 0, total: 484 },
    { name: 'CO/VI检测器', icon: icon12, abnormal: 0, total: 484 },
    { name: '温湿度传感器', icon: icon13, abnormal: 0, total: 484 },
    { name: '压力传感器', icon: icon14, abnormal: 0, total: 484 },
    { name: '光照度变送器', icon: icon15, abnormal: 0, total: 484 },
    { name: '紧急电话', icon: icon5, abnormal: 0, total: 484 },
    { name: '水质监测设备', icon: icon6, abnormal: 0, total: 484 }
  ],
  lighting: [
