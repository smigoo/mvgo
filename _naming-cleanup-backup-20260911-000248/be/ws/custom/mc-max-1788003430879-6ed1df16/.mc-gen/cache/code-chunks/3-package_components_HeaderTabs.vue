<template>
  <div class="c-env-monitor-header-tabs">
    ...
    <div class="c-env-monitor-tabs-list" :style="{ backgroundImage: `url(${bg2})` }">
    ...
    <div class="c-env-monitor-tabs-icon">
      ...
      <div class="c-env-monitor-icon-btn">
        <img :src="icon1" class="c-env-monitor-icon-img" alt="柱状图视图" />
      </div>
      <!-- 图标按钮 2（列表视图） -->
      <div class="c-env-monitor-icon-btn">
        <img :src="icon2" class="c-env-monitor-icon-img" alt="列表视图" />
      </div>
    </div>
