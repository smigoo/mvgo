    ...
    <div class="c-monitor-flow-prediction-body" :style="{ backgroundImage: `url(${bg4})` }">
      ...
      <div class="c-monitor-flow-prediction-legend">
        <div class="c-monitor-flow-prediction-legend-item">
          <span class="c-monitor-flow-prediction-legend-dot actual"></span>
          <span class="c-monitor-flow-prediction-legend-text">实际流量</span>
        </div>
        <div class="c-monitor-flow-prediction-legend-item">
          <span class="c-monitor-flow-prediction-legend-dot predict"></span>
...
const mockData = {
  tunnel: {
    actual: [2800, 2600, 2400, 2200, 2000],
    predict: [null, null, null, 2100, 1900, 1800, 1700]
  },
  bridge: {
    actual: [3200, 3000, 2800, 2600, 2400],
    predict: [null, null, null, 2500, 2300, 2200, 2100]
  }
}
