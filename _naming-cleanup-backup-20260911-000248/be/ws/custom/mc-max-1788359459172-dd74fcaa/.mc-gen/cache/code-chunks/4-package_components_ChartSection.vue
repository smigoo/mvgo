...
// 各 Tab 对应的模拟数据
const tabDataMap = {
  co: [2, 3, 2.5, 4, 5, 8, 12, 15, 13, 10, 7, 5],
  visibility: [800, 750, 700, 680, 720, 800, 850, 900, 880, 820, 760, 800],
  indoorLight: [200, 210, 220, 230, 240, 260, 280, 270, 250, 230, 210, 200],
  outdoorLight: [100, 200, 400, 600, 800, 900, 850, 700, 500, 300, 150, 80]
}

const getChartData = (tab) => {
  return tabDataMap[tab] || tabDataMap['co']
}

const getWarningLineValue = (tab) => {
  if (tab === 'co') return 30
  return null
}
