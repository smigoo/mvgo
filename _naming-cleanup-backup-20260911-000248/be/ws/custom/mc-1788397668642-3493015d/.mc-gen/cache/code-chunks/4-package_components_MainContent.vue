    ...
    <div class="c-monitor-switch-bar">
      ...
      >
        <div class="c-monitor-switch-item-icon">
          <img :src="icon1" alt="隧道设备图标" class="c-monitor-switch-icon-img" />
        </div>
        <div class="c-monitor-switch-item-info">
          <div class="c-monitor-switch-item-title">隧道设备</div>
          <div class="c-monitor-switch-item-stats">
            <div class="c-monitor-switch-stat-line">
              <span class="c-monitor-switch-stat-label">总数:</span>
              <span class="c-monitor-switch-stat-value c-monitor-switch-stat-value--blue">56302</span>
            </div>
            <div class="c-monitor-switch-stat-line">
              <span class="c-monitor-switch-stat-label">异常数:</span>
              <span class="c-monitor-switch-stat-value c-monitor-switch-stat-value--red">5</span>
            </div>
          </div>
        </div>
      </div>
      ...
      >
        <div class="c-monitor-switch-item-icon">
          <img :src="icon2" alt="南北接线设备图标" class="c-monitor-switch-icon-img" />
        </div>
        <div class="c-monitor-switch-item-info">
          ...
          <div class="c-monitor-device-card-inner">
            ...
            <div class="c-monitor-device-info">
              ...
              <div class="c-monitor-device-count">
                <span class="c-monitor-device-count-text">{{ device.count }}</span>
              </div>
            </div>
          </div>
        </div>
