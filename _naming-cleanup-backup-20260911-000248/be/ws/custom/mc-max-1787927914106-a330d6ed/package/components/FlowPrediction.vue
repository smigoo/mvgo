<template>
  <div class="c-monitor-prediction-root">
    ...
    <div class="c-monitor-prediction-header">
      <div class="c-monitor-prediction-title-wrapper">
        <img :src="icon3" class="c-monitor-prediction-icon" alt="" />
      ...
      <!-- 节假日预测链接 -->
      <a href="javascript:;" class="c-monitor-prediction-link">节假日预测</a>
    </div>
    ...
    <div class="c-monitor-prediction-chart-wrapper">
      ...
      <div class="c-monitor-prediction-legend">
        <span
          class="c-monitor-prediction-legend-item"
          :class="{ active: legendState.c-monitor-actual }"
          @click="toggleLegend('实际流量')"
        >
          <i class="c-monitor-prediction-legend-dot c-monitor-actual"></i>
          实际流量
        </span>
        <span
          class="c-monitor-prediction-legend-item"
          :class="{ active: legendState.c-monitor-predict }"
          @click="toggleLegend('预测流量')"
        >
          <i class="c-monitor-prediction-legend-dot c-monitor-predict"></i>
          预测流量
        </span>
      </div>
...
const legendState = ref({
  'c-monitor-actual': true,
  'c-monitor-predict': true
})
...
const dataMap = {
  tunnel: {
    ...
    'c-monitor-actual': [2800, 3200, 3500, null, null],
    'c-monitor-predict': [null, null, 3500, 3300, 3100],
    accuracy: ['准确率98%', '准确率96%', '准确率92%']
  },
  bridge: {
    xAxis: ['2小时前', '1小时前', '当前时间', '1小时后', '2小时后'],
    'c-monitor-actual': [3200, 3600, 3800, null, null],
    'c-monitor-predict': [null, null, 3800, 3600, 3400],
...
.c-monitor-prediction-title-wrapper {
  display: flex;
  align-items: center;
  gap: 6px;
}
