  ...
  <div class="c-monitor-bridge-hourly">
    ...
    <div class="c-monitor-chart-wrapper">
      ...
      <div class="c-monitor-chart-legend">
        ...
        >
          <i class="c-monitor-legend-dot c-monitor-beijing"></i>
        ...
        >
          <i class="c-monitor-legend-dot c-monitor-shanghai"></i>
...
const mockData = {
  ...
  'c-monitor-beijing': [120, 150, 180, 220, 350, 420, 520, 680, 825, 720, 580, 420, 280],
  'c-monitor-shanghai': [100, 130, 160, 200, 330, 400, 500, 660, 831, 700, 560, 400, 260]
}
