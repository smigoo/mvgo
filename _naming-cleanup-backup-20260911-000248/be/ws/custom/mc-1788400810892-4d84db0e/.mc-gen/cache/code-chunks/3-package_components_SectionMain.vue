      ...
      <div class="c-monitor-switch-row">
        ...
        >
          ...
          <div class="c-monitor-switch-info">
            <span class="c-monitor-switch-title c-monitor-switch-title--active">隧道设备</span>
        ...
        >
          <div class="c-monitor-switch-icon-wrap">
            <img :src="icon2" class="c-monitor-switch-icon" alt="南北拦线设备图标" />
          </div>
          <div class="c-monitor-switch-info">
            <span class="c-monitor-switch-title c-monitor-switch-title--default">南北拦线设备</span>
            <div class="c-monitor-switch-stat-row">
              <span class="c-monitor-switch-stat-label">总&nbsp;&nbsp;数：</span>
