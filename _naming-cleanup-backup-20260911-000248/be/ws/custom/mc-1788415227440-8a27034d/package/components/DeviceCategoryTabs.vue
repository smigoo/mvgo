...
@color-tab-title: #333333;
@color-tab-title-active: #333333;
@fontWeightStrong: 400;
@color-tab-stat-label: #333333;
@color-tab-stat-label-active: #333333;
@color-tab-stat-value: #333333;
@color-tab-stat-value-active: #333333;
...
.c-monitor-tab-stat-value--danger {
  color: var(--color-danger, rgba(255, 85, 85, 1));
}
...
.c-monitor-tab-badge {
  ...
  background: var(--color-danger, rgba(255, 85, 85, 1));
  color: #ffffff;
  font-size: calc(var(--fontSize, 14px) * 0.86);
  font-weight: @fontWeightStrong;
  border-radius: 9px;
