  ...
  <div class="c-monitor-daily-flow-root">
    ...
    >
      ...
      <div class="c-monitor-daily-flow-stat-card">
        ...
        <div class="c-monitor-daily-flow-stat-value tunnel">34,620</div>
      </div>

      <!-- 江阴大桥统计 -->
      <div class="c-monitor-daily-flow-stat-card">
        <div class="c-monitor-daily-flow-stat-label">江阴大桥</div>
        <div class="c-monitor-daily-flow-stat-value bridge">82,379</div>
      </div>
...
.c-monitor-daily-flow-root {
  // flex-grow 使用与兄弟区块统一的像素量级（Figma 区块高度约 160px）
  flex: 160 1 0;
  min-height: 0;
  display: flex;
