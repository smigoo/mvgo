  ...
  <div class="c-mc-max-1787736422136-74deb182-c-monitor-forecast">
    <div class="c-mc-max-1787736422136-74deb182-c-monitor-forecast-header">
      ...
      <div class="c-mc-max-1787736422136-74deb182-c-monitor-forecast-tabs">
        <div 
          :class="['c-monitor-forecast-tab', { c-mc-max-1787736422136-74deb182-active: activeTab === 'tunnel' }]"
          @click="activeTab = 'tunnel'"
        >江阴靖江长江隧道</div>
        <div 
          :class="['c-monitor-forecast-tab', { c-mc-max-1787736422136-74deb182-active: activeTab === 'bridge' }]"
    ...
    <div class="c-mc-max-1787736422136-74deb182-c-monitor-forecast-chart-wrapper">
      ...
      <div class="c-mc-max-1787736422136-74deb182-c-monitor-forecast-legend">
        <div 
          ...
          :class="{ c-mc-max-1787736422136-74deb182-inactive: !legendState.c-mc-max-1787736422136-74deb182-actual }" 
          @click="toggleLegend('actual', '实际流量')"
        >
          <span class="c-mc-max-1787736422136-74deb182-c-monitor-forecast-legend-line c-mc-max-1787736422136-74deb182-actual"></span>
          <span>实际流量</span>
        </div>
        <div 
          class="c-mc-max-1787736422136-74deb182-c-monitor-forecast-legend-item" 
          :class="{ c-mc-max-1787736422136-74deb182-inactive: !legendState.c-mc-max-1787736422136-74deb182-forecast }" 
          @click="toggleLegend('forecast', '预测流量')"
        >
          <span class="c-mc-max-1787736422136-74deb182-c-monitor-forecast-legend-line c-mc-max-1787736422136-74deb182-forecast"></span>
          <span>预测流量</span>
        </div>
      </div>
...
const legendState = ref({ c-mc-max-1787736422136-74deb182-actual: true, c-mc-max-1787736422136-74deb182-forecast: true })

const mockData = {
  tunnel: {
    c-mc-max-1787736422136-74deb182-actual: [1200, 1800, 2400, 2100, 1900],
    c-mc-max-1787736422136-74deb182-forecast: [1300, 1900, 2500, 2200, 2000]
  },
  bridge: {
    c-mc-max-1787736422136-74deb182-actual: [2500, 3200, 3800, 3500, 3100],
    c-mc-max-1787736422136-74deb182-forecast: [2600, 3300, 3900, 3600, 3200]
  }
}
