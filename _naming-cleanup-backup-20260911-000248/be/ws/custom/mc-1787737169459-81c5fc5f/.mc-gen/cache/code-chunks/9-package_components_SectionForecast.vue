  ...
  <div class="c-monitor-forecast">
    <div class="c-monitor-forecast-header">
      <div class="c-monitor-forecast-title">
        <img :src="icon7" class="c-monitor-forecast-icon" alt="icon" />
        <span>流量预测</span>
      </div>
      ...
      <div class="c-monitor-forecast-link" @click="handleHolidayClick">节假日预测</div>
    </div>
    ...
    <div class="c-monitor-forecast-chart-wrapper">
      ...
      <div class="c-monitor-forecast-legend">
        ...
        >
          <span class="c-monitor-forecast-legend-line actual"></span>
          <span>实际流量</span>
        </div>
        <div 
          class="c-monitor-forecast-legend-item" 
        ...
        >
          <span class="c-monitor-forecast-legend-line forecast"></span>
          <span>预测流量</span>
        </div>
      </div>
...
const icon7 = window.__mc_resources__?.icon7 || ''
