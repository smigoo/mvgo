<template>
  <div class="c-monitor-vehicle-type">
    <div class="c-monitor-vehicle-header">
      <img :src="icon6" class="c-monitor-vehicle-icon" alt="icon" />
      <span class="c-monitor-vehicle-title">车型分布</span>
    </div>
    <div class="c-monitor-vehicle-content">
      <!-- 江阴靖江长江隧道 -->
      <div class="c-monitor-vehicle-card" :style="{ backgroundImage: `url(${bg2})`, backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' }">
        <div class="c-monitor-vehicle-card-title">江阴靖江长江隧道</div>
        <div class="c-monitor-vehicle-card-body">
          ...
          <div class="c-monitor-vehicle-stats">
            <div class="c-monitor-vehicle-stat">
              ...
              <span class="c-monitor-vehicle-stat-value" style="color: #1399ff;">22350</span>
            </div>
            <div class="c-monitor-vehicle-stat">
              <span class="c-monitor-vehicle-stat-label">货车</span>
              <span class="c-monitor-vehicle-stat-value" style="color: #ff6a00;">16270</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- 江阴大桥 -->
      <div class="c-monitor-vehicle-card" :style="{ backgroundImage: `url(${bg4})`, backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' }">
        <div class="c-monitor-vehicle-card-title">江阴大桥</div>
        <div class="c-monitor-vehicle-card-body">
          <div class="c-monitor-vehicle-chart-wrapper">
          ...
          <div class="c-monitor-vehicle-stats">
            <div class="c-monitor-vehicle-stat">
              <span class="c-monitor-vehicle-stat-label">客车</span>
              <span class="c-monitor-vehicle-stat-value" style="color: #1399ff;">66109</span>
            </div>
            <div class="c-monitor-vehicle-stat">
              <span class="c-monitor-vehicle-stat-label">货车</span>
              <span class="c-monitor-vehicle-stat-value" style="color: #ff6a00;">16270</span>
