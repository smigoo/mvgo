      ...
      <div class="c-mc-max-1787971283413-e8e268ae-c-monitor-bridge-legend">
        <span
         ...
         :style="legendState.beijing ? { backgroundImage: 'url(' + bg3 + ')', backgroundSize: '100% 100%', backgroundRepeat: 'no-repeat' } : null">
          <i class="c-mc-max-1787971283413-e8e268ae-c-monitor-bridge-legend-dot c-mc-max-1787971283413-e8e268ae-c-monitor-beijing"></i>
          北京方向
        </span>
        <span
          class="c-mc-max-1787971283413-e8e268ae-c-monitor-bridge-legend-item"
        ...
        >
          <i class="c-mc-max-1787971283413-e8e268ae-c-monitor-bridge-legend-dot c-mc-max-1787971283413-e8e268ae-c-monitor-shanghai"></i>
          上海方向
        </span>
      </div>
...
// 模拟数据（24小时）
const hourlyData = {
  'c-monitor-beijing': [120, 200, 150, 180, 220, 240, 300, 350, 400, 380, 420, 450, 500, 480, 460, 440, 500, 520, 480, 450, 400, 350, 300, 250],
  'c-monitor-shanghai': [100, 180, 130, 160, 200, 220, 280, 320, 380, 360, 400, 430, 480, 460, 440, 420, 480, 500, 460, 430, 380, 330, 280, 230]
}
