<template>
  <base-panel class="c-mc-max-1788373364090-82cda86e" panelKey="default-panel">
...
// === 组件加载事件 ===
const emitLoadEvent = () => { if (!runtimeBuilder || typeof runtimeBuilder.publishEvent !== 'function ') { console.warn('[设备监测] runtimeBuilder 不可用，跳过 onload 事件')
    return
  }
