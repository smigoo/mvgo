<template>
  <div class="c-monitor-section c-monitor-tunnel-hourly">
    ...
    series: [
      {
        name: '北京方向',
        type: 'bar',
        data: [1200, 1500, 1800, 2200, 2800, 3200, 3500, 3800, 3600, 3200, 2800, 2400, 2000, 1800, 1600, 1800, 2200, 2600, 2800, 2600, 2200, 1800, 1400, 1000],
      ...
      },
      {
        name: '上海方向',
        type: 'bar',
        data: [1000, 1300, 1600, 2000, 2600, 3000, 3300, 3600, 3400, 3000, 2600, 2200, 1800, 1600, 1400, 1600, 2000, 2400, 2600, 2400, 2000, 1600, 1200, 800],
